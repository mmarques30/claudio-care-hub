...
export default function Pacientes() {
  ...
  const stateLabels: Record<string, string> = {
    ...
    duvidas: "Dúvidas",
    agendamento_dia: "Agendando (dia)",
    agendamento_hora: "Agendando (hora)",
    agendamento_nome: "Agendando (nome)",
              ...
              <div className="space-y-4">
                {conversation && (
                  <div className="p-3 rounded-lg bg-muted/50">
                    ...
                    <p className="text-sm font-medium">{stateLabels[conversation.current_state] || conversation.current_state}</p>
                  </div>
                )}
                {history.length === 0 ? (
